...
$new_arrivals_query = "SELECT p.*, GROUP_CONCAT(pi.filename) AS images\n                       FROM Products p\n                       LEFT JOIN Product_images pi ON p.id = pi.product_id\n                       GROUP BY p.id\n                       ORDER BY p.id DESC\n                       LIMIT 8";
$new_arrivals_result = mysqli_query($db, $new_arrivals_query);
                            ...
                            <div class="wrapper-section" data-aos="fade-up">
                                <div class="wrapper-info">
                                    ...
                                    <h1 class="wrapper-details">Fashion Collection
                                        Summer Sale</h1>
                                    <a href="product-info.php" class="shop-btn">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one" data-aos="fade-right">
                            <div class="wrapper-info">
                                ...
                                <a href="product-info.php" class="shop-btn">Shop Now
                                    <span>
    ...
    <section class="product-category">
        <div class="container">
            <div class="section-title">
                ...
                <a href="product-info.php" class="view">View All</a>
            </div>
            <div class="category-section">
                <?php foreach ($categories as $index => $category): ?>
                    <?php $delay = 100 + ($index % 6) * 100; ?>
                    <div class="product-wrapper" data-aos="fade-right" data-aos-duration="<?php echo $delay; ?>">
                        <div class="wrapper-info">
                            <a href="product-info.php?category=<?php echo $category['id']; ?>" class="wrapper-details">
                ...
                <div class="row g-5">
                        ...
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Rainbow Sequin Dress
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <a href="cart.php" class="product-btn">Add To Cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Feminine Wrap Blouse
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Trendy Bucket Hat
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Boho Maxi Dress
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Casual Denim Jacket
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$20.99</span>
                                        <span class="new-price">$10.99</span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Stylish Statement Earrings
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$20.99</span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Leather Dress Shoes
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Wool Peacoat
                                    </a>
                                    <div class="price">
                    ...
                    if (!empty($new_arrivals)) :
                        foreach ($new_arrivals as $product) :
                            ...
                            $imagePath = $firstImage ? "assets/images/products/{$firstImage}" : "assets/images/homepage-one/product-img/product-img-1.webp";
                    ...
                    ?>
                        <div class="col-lg-3 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                <div class="product-img">
                                    <a href="product-info.php?id=<?php echo $product['id']; ?>">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="product-info.php?id=<?php echo $product['id']; ?>" class="product-details"><?php echo $productName; ?></a>
                                        <div class="price">
                                ...
                                <div class="product-cart-btn">
                                    <a href="cart.php?action=add&id=<?php echo $product['id']; ?>&qty=1" class="product-btn">Add To Cart</a>
                                </div>
                            </div>
                        </div>
                    <?php
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Stylish Earrings
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Rainbow Dress
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$12.99</span>
                                        <span class="new-price">$6.99</span>
...
<!--------------- weekly-section--------------->
    ...
    <?php
                $bestSelling = "select * from products left join product_images 
                ON products.id = product_images.product_id";
                $bestSellingResult = mysqli_query($db, $bestSelling);

                $bestSellingResultCheck = mysqli_num_rows($bestSellingResult);
                $bestSelling = [];
                if ($bestSellingResultCheck) {
    ...
    <section class="product weekly-sale">
        <div class="container">
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                <?php
                    foreach ($bestSelling as $bestSellingRow) {
                    ?>    

                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="<?php echo getProductImage($bestSellingRow) ?>" alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">
                                        <?php echo $bestSellingRow['product_name'] ?>
                                    </a>
                                    <div class="price">
                                        <span class="price-cut"></span>
                                        <span class="new-price"><?php echo $bestSellingRow['product_price'] ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="product-cart-btn">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Half Sleeve Dress
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$12.99</span>
                                        <span class="new-price">$6.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Feminine Wrap coat
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$18.99</span>
                                        <span class="new-price">$10.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Black suit
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Rainbow Party Dress
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$19.99</span>
                                        <span class="new-price">$8.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Rainbow Sequin Skart
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$15.99</span>
                                        <span class="new-price">$7.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Red Sequin Hat
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$13.99</span>
                                        <span class="new-price">$7.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Gradient Party Shirt
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$19.99</span>
                                        <span class="new-price">$10.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Flower Design Dress
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$19.99</span>
                                        <span class="new-price">$8.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Blue Suit
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$10.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Blue Party Dress
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$9.99</span>
                                        <span class="new-price">$6.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">White Hat
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$29.99</span>
                                        <span class="new-price">$26.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">White Checked Shirt
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$19.99</span>
                                        <span class="new-price">$16.99</span>
