...
if (!empty($_SESSION['cart'])) {
    ...
    $query_cart = "SELECT p.id, p.product_name, p.price, pi.filename FROM Products p LEFT JOIN Product_images pi ON p.id = pi.product_id WHERE p.id IN ($ids_str) GROUP BY p.id";
...
<php lang="en">
    ...
    <!-- Mirrored from quomodothemes.website/php/shopus/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 13:15:33 GMT -->

    <head>
        <meta charset="utf-8">
        <meta name="keywords"
            content="ShopUS, bootstrap-5, bootstrap, sass, css, php Template, php,php, bootstrap template, free template, figma, web design, web development,front end, bootstrap datepicker, bootstrap timepicker, javascript, ecommerce template">
                    ...
                    <div class="header-top">
                        <div class="header-profile">
                            <?php if (isset($_SESSION['user_name'])): ?>
                                <a href="user-profile.php"><span>Welcome, <?php echo htmlspecialchars($_SESSION['user_name']); ?></span></a>
                                <span style="margin: 0 8px; color: #6E6D79;">|</span>
                                <a href="logout.php"><span>Logout</span></a>
                            <?php else: ?>
                                <a href="login.php"><span>Login</span></a>
                                <span style="margin: 0 8px; color: #6E6D79;">|</span>
                                <a href="create-account.php"><span>Sign Up</span></a>
                            <?php endif; ?>
                        </div>
                                ...
                                <div class="cart-submenu">
                                    ...
                                    <div class="cart-wrapper-section">
                                        ...
                                        <div class="wrapper-subtotal">
                                            ...
                                            <h5 class="wrapper-title">$<?php echo number_format($subtotal, 2); ?></h5>
                                        </div>
                                        <div class="cart-btn">
                                            <a href="cart.php" class="shop-btn view-btn">View Cart</a>
                                            <a href="cart.php" class="shop-btn checkout-btn">Checkout Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
