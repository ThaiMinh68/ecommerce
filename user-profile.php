...
// Get user info
$user_res = mysqli_query($db, "SELECT * FROM Users WHERE id = $user_id");
$user_data = mysqli_fetch_assoc($user_res);

// Get orders info
$orders_res = mysqli_query($db, "SELECT * FROM orders WHERE user_id = $user_id ORDER BY id DESC");
?>
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="user-profile">
                                <div class="user-title">
                                    <p class="paragraph">Hello, <?php echo htmlspecialchars($user_data['first_name'] . ' ' . $user_data['last_name']); ?></p>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="product-wrapper">
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <h3 class="heading"><?php echo mysqli_num_rows($orders_res); ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-sm-6">
                                                ...
                                                <div class="shop-info">
                                                    ...
                                                    <div class="info-list">
                                                        ...
                                                        <div class="info-details">
                                                            ...
                                                            <p><a href="https://quomodothemes.website/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6f0b0a02000a020e06032f08020e0603410c0002">[email&#160;protected]</a></p>
                                                            <p>023 434 54354</p>
                                ...
                                <table>
                                     <tbody>
                                        <tr class="table-row table-top-row">
                                            <td class="table-wrapper"><h5 class="table-heading">ORDER CODE</h5></td>
                                            <td class="table-wrapper"><div class="table-wrapper-center"><h5 class="table-heading">TOTAL</h5></div></td>
                                            <td class="table-wrapper"><div class="table-wrapper-center"><h5 class="table-heading">QTY</h5></div></td>
                                            <td class="table-wrapper wrapper-total"><div class="table-wrapper-center"><h5 class="table-heading">PAYMENT</h5></div></td>
                                            <td class="table-wrapper"><div class="table-wrapper-center"><h5 class="table-heading">STATUS</h5></div></td>
                                        </tr>
                                        <?php 
                                        mysqli_data_seek($orders_res, 0); // Reset result set pointer
                                        while($order = mysqli_fetch_assoc($orders_res)): 
                                        ?>
                                        <tr class="table-row ticket-row">
                                            <td class="table-wrapper">
                                                <div class="wrapper-content">
                                                    <h5 class="heading">#<?php echo htmlspecialchars($order['code']); ?></h5>
                                                </div>
                                            </td>
                                            <td class="table-wrapper">
                                                <div class="table-wrapper-center">
                                                    <h5 class="heading">$<?php echo number_format($order['total'], 2); ?></h5>
                                                </div>
                                            </td>
                                            <td class="table-wrapper">
                                                <div class="table-wrapper-center">
                                                    <h5 class="heading"><?php echo $order['quantity']; ?></h5>
                                                </div>
                                            </td>
                                            <td class="table-wrapper wrapper-total">
                                                <div class="table-wrapper-center">
                                                    <h5 class="heading"><?php echo htmlspecialchars($order['payment']); ?></h5>
                                                </div>
                                            </td>
                                            <td class="table-wrapper">
                                                <div class="table-wrapper-center">
                                                    <span class="badge <?php echo ($order['status'] == 'Pending') ? 'bg-warning' : 'bg-success'; ?>" style="padding: 5px 10px; border-radius: 5px; color: white;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="seller-info">
                                            ...
                                            <div class="info-list">
                                                ...
                                                <div class="info-details">
                                                    <p>Sajjad</p>
                                                    <p><a href="https://quomodothemes.website/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e185848c8e848c80888da1868c80888dcf828e8c">[email&#160;protected]</a></p>
                                                    <p>023 434 54354</p>
                                                    <p>Haydarabad, Rord 34</p>
                                                    <p>3454</p>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="seller-info">
                                            ...
                                            <div class="info-list">
                                                ...
                                                <div class="info-details">
                                                    <p>Sajjad</p>
                                                    <p><a href="https://quomodothemes.website/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3f5b5a52505a525e56537f58525e5653115c5052">[email&#160;protected]</a></p>
                                                    <p>023 434 54354</p>
                                                    <p>Haydarabad, Rord 34</p>
                                                    <p>3454</p>
                                                </div>
                                        ...
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-description">
                                                    <a href="product-sidebar.php" class="product-details">Rainbow
                                                        Sequin Dress
                                                    </a>
